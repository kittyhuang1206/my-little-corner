    ...
    if(onbStep===0) return(
      <div className="onb" style={{background:P.bg}}><style>{css}</style>
        <div className="onb-c">
          ...
          <p style={{fontSize:12.5,color:P.muted,fontFamily:font.sans,marginBottom:24,lineHeight:1.7}}>A cozy place for your thoughts and little moments.<br/>記錄生活的小角落</p>
